...
//		}
    ...
    {
        [ThreadStatic] private static RandomFaster local;
        public static RandomFaster This => local ?? (local = new RandomFaster(unchecked(Environment.TickCount * 31 + System.Threading.Thread.CurrentThread.ManagedThreadId)));
    }
}